...
public class MonsterDB {
    ...
    public MonsterDB(){
        ...
        this.monsterList.put(9, new Monster(9,"마그테리돈", 5, 5, 5, 100,null));
        this.monsterList.put(10, new Monster(10,"여군주 바쉬", 5, 5, 5, 100,null));
        this.monsterList.put(11, new Monster(11,"줄진", 5, 5, 5, 100,null));
        this.monsterList.put(12, new Monster(12,"공작 말체자르", 5, 5, 5, 100,null));
        this.monsterList.put(13, new Monster(13,"파멸의 어둠", 5, 5, 5, 100,null));
       ...
       /// 불타는 성전 최종
        ...
        this.monsterList.put(40, new Monster(40,"살게라스의 무덤 킬제덴", 5, 5, 5, 100,null));
        // 군단 중간
        this.monsterList.put(41, new Monster(41,"사멸자 아르거스", 5, 5, 5, 100,null));
        /// 군단 최종
        this.monsterList.put(42, new Monster(42,"그훈", 5, 5, 5, 100,null));
        this.monsterList.put(43, new Monster(43,"여군주 제이나 프라우드무어", 5, 5, 5, 100,null));
        this.monsterList.put(44, new Monster(44,"공허의 전령 우우나트", 5, 5, 5, 100,null));
        this.monsterList.put(45, new Monster(45,"여왕 아즈샤라", 5, 5, 5, 100,null));
        // 격전의 아제로스 중간
        this.monsterList.put(46, new Monster(46,"타락자 느조스", 5, 5, 5, 100,null));
        /// 격전의 아제로스 최종
        this.monsterList.put(47, new Monster(47,"대영주 데나트리우스", 5, 5, 5, 100,null));
        this.monsterList.put(48, new Monster(48,"실바나스 윈드러너", 5, 5, 5, 100,null));
        // 어둠땅 중간
        this.monsterList.put(49, new Monster(49,"간수-조바알", 5, 5, 5, 100,null));
        ///어둠땅 최종
        this.monsterList.put(50, new Monster(50,"폭풍포식자 라자게스", 5, 5, 5, 100,null));
        this.monsterList.put(51, new Monster(51,"비늘사령관 사카레스", 5, 5, 5, 100,null));
        //용군단 중간
    }
